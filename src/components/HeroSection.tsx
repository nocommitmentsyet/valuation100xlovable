...
export const HeroSection = () => {
  return (
    <div className="w-full min-h-[80vh] relative overflow-hidden bg-gradient-subtle">
      <div className="relative z-10 pt-32 text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-foreground w-full text-center font-bold">
        DeepResearch
      </div>
      <p className="relative z-10 pt-6 text-lg sm:text-xl md:text-2xl text-muted-foreground w-full text-center max-w-3xl mx-auto px-4">
